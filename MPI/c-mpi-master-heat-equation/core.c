...
/*Modificado por: Adriana Villamizar-Gysselis Vasques, 28-20-2023 */
...
void evolve_edges(field *curr, field *prev, double a, double dt)
{
   ...
   /* Para optimizar duplicidad de código, se reduce a dos for anidados, con las condiciones de forma que el contador
   * solo tome los dos valores posibles que tomaba originalmente */
   /* se agrega paralelización con omp */
    #pragma omp parallel for
    for (i=1; i<=curr->nx; i=i*curr->nx) {
